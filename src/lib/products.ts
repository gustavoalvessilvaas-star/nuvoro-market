...
export const seedProducts: Product[] = [
  {
    ...
    benefits: ["Built-in LED light for better visibility", "Gentle grinding instead of harsh clipping", "Designed for dogs and cats", "Compact and easy to use at home", "Helps make routine grooming feel more controlled"],
    details: { "Product type": "Electric Pet LED Nail Grinder", "Bundle options": "1x, 2x Best Value, 3x Family Pack", "Main concern": "Traditional clippers can feel stressful for pets and owners." },
    faqs: [
      { question: "Is this for dogs and cats?", answer: "Yes. Use slow, gentle passes and follow your pet's comfort level." },
      { question: "How should I use it with a nervous pet?", answer: "Let your pet see and hear the grinder first, start with short sessions, use light pressure and offer breaks or rewards." },
      { question: "Does it replace professional grooming?", answer: "It is designed for routine at-home nail care. For medical concerns, injuries or very difficult nails, contact a qualified groomer or veterinarian." },
