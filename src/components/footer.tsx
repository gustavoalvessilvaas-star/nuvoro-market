    ...
    <footer className="mt-16 border-t border-line bg-white">
      <div className="container-page grid gap-8 py-10 md:grid-cols-[1.2fr_1fr_1fr]">
        <div>
          ...
          <p className="mt-2 max-w-md text-sm text-ink/70">{siteConfig.promise}</p>
          <p className="mt-4 text-sm text-ink/70">Support: {siteConfig.supportEmail}</p>
        </div>
        <div>
      ...
      <div className="border-t border-line py-4 text-center text-xs text-ink/60">© 2026 Nuvoro Market. All rights reserved.</div>
    </footer>
  );
}
